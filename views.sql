...
-- View -> A "saved SQL statement", you can select from this view instead of selecting from tables directly
-- View is an object stored in the database
-- It works like a table, but it's actually a select statement that refers to other tables

create view olympic_games as
...
-- INSERT INTO games (id, games_year, games_name, season) VALUES
